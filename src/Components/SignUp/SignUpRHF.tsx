...
import { SignUpUser , UserUpdateProfile,UserGoogleLogin } from '../../Redux/Slice/FirebaseAuthSlice';
...
const SignUpRHF : React.FC = () => {
  ...
  useEffect(() => {
    ...
    return (
      ...
      {isSignupError && user.error && <div role="alert" className="alert alert-error">
